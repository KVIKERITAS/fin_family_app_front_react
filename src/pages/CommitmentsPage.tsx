...
// import CreateCommitmentDialog from '@/components/CommitmentsComponents/CreateCommitmentDialog'; // Correct import path
//
...
// 				<span className="font-bold text-xl">{description} - {projectNumber} eur.</span>
